...
/// guess, and a density minted from a guess decides what units admit.
 bool get servingOfferTaken; DensityChange get density; List<Measure> get measuresAdded; Set<String> get measuresRemoved; DefaultMeasureChange get defaultMeasure; List<IngredientAlias> get aliasesAdded; Set<String> get aliasesRemoved;/// A provenance the scan or the USDA pick stamped and the next Save writes
...
/// back the resolved spoon — the density entry pre-picks it.
 Unit? get redirectedSpoon;/// The form's one feedback line.
...
@useResult
$Res call({
 Ingredient row, bool creating, String name, String category, Unit defaultUnit, MacrosBasis basis, Set<Unit> allowed, MacroDraft macros, MacroDraft seededMacros, int macroSeed, int nameSeed, int servingSeed, bool perServing, ServingDraft serving, bool servingOfferTaken, DensityChange density, List<Measure> measuresAdded, Set<String> measuresRemoved, DefaultMeasureChange defaultMeasure, List<IngredientAlias> aliasesAdded, Set<String> aliasesRemoved, String? pendingSource, String? pendingSourceLabel, double? pendingSourceScore, IngredientDraft? scanned, DraftApplication? scanApplied, bool packAdded, Unit? redirectedSpoon, String? message, bool busy
});
...
as DensityChange,measuresAdded: null == measuresAdded ? _self.measuresAdded : measuresAdded // ignore: cast_nullable_to_non_nullable
...
as Set<String>,defaultMeasure: null == defaultMeasure ? _self.defaultMeasure : defaultMeasure // ignore: cast_nullable_to_non_nullable
as DefaultMeasureChange,aliasesAdded: null == aliasesAdded ? _self.aliasesAdded : aliasesAdded // ignore: cast_nullable_to_non_nullable
...
as Unit?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Ingredient row,  bool creating,  String name,  String category,  Unit defaultUnit,  MacrosBasis basis,  Set<Unit> allowed,  MacroDraft macros,  MacroDraft seededMacros,  int macroSeed,  int nameSeed,  int servingSeed,  bool perServing,  ServingDraft serving,  bool servingOfferTaken,  DensityChange density,  List<Measure> measuresAdded,  Set<String> measuresRemoved,  DefaultMeasureChange defaultMeasure,  List<IngredientAlias> aliasesAdded,  Set<String> aliasesRemoved,  String? pendingSource,  String? pendingSourceLabel,  double? pendingSourceScore,  IngredientDraft? scanned,  DraftApplication? scanApplied,  bool packAdded,  Unit? redirectedSpoon,  String? message,  bool busy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IngredientFormDraft() when $default != null:
return $default(_that.row,_that.creating,_that.name,_that.category,_that.defaultUnit,_that.basis,_that.allowed,_that.macros,_that.seededMacros,_that.macroSeed,_that.nameSeed,_that.servingSeed,_that.perServing,_that.serving,_that.servingOfferTaken,_that.density,_that.measuresAdded,_that.measuresRemoved,_that.defaultMeasure,_that.aliasesAdded,_that.aliasesRemoved,_that.pendingSource,_that.pendingSourceLabel,_that.pendingSourceScore,_that.scanned,_that.scanApplied,_that.packAdded,_that.redirectedSpoon,_that.message,_that.busy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Ingredient row,  bool creating,  String name,  String category,  Unit defaultUnit,  MacrosBasis basis,  Set<Unit> allowed,  MacroDraft macros,  MacroDraft seededMacros,  int macroSeed,  int nameSeed,  int servingSeed,  bool perServing,  ServingDraft serving,  bool servingOfferTaken,  DensityChange density,  List<Measure> measuresAdded,  Set<String> measuresRemoved,  DefaultMeasureChange defaultMeasure,  List<IngredientAlias> aliasesAdded,  Set<String> aliasesRemoved,  String? pendingSource,  String? pendingSourceLabel,  double? pendingSourceScore,  IngredientDraft? scanned,  DraftApplication? scanApplied,  bool packAdded,  Unit? redirectedSpoon,  String? message,  bool busy)  $default,) {final _that = this;
switch (_that) {
case _IngredientFormDraft():
return $default(_that.row,_that.creating,_that.name,_that.category,_that.defaultUnit,_that.basis,_that.allowed,_that.macros,_that.seededMacros,_that.macroSeed,_that.nameSeed,_that.servingSeed,_that.perServing,_that.serving,_that.servingOfferTaken,_that.density,_that.measuresAdded,_that.measuresRemoved,_that.defaultMeasure,_that.aliasesAdded,_that.aliasesRemoved,_that.pendingSource,_that.pendingSourceLabel,_that.pendingSourceScore,_that.scanned,_that.scanApplied,_that.packAdded,_that.redirectedSpoon,_that.message,_that.busy);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey() final  DefaultMeasureChange defaultMeasure;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IngredientFormDraft&&(identical(other.row, row) || other.row == row)&&(identical(other.creating, creating) || other.creating == creating)&&(identical(other.name, name) || other.name == name)&&(identical(other.category, category) || other.category == category)&&(identical(other.defaultUnit, defaultUnit) || other.defaultUnit == defaultUnit)&&(identical(other.basis, basis) || other.basis == basis)&&const DeepCollectionEquality().equals(other._allowed, _allowed)&&(identical(other.macros, macros) || other.macros == macros)&&(identical(other.seededMacros, seededMacros) || other.seededMacros == seededMacros)&&(identical(other.macroSeed, macroSeed) || other.macroSeed == macroSeed)&&(identical(other.nameSeed, nameSeed) || other.nameSeed == nameSeed)&&(identical(other.servingSeed, servingSeed) || other.servingSeed == servingSeed)&&(identical(other.perServing, perServing) || other.perServing == perServing)&&(identical(other.serving, serving) || other.serving == serving)&&(identical(other.servingOfferTaken, servingOfferTaken) || other.servingOfferTaken == servingOfferTaken)&&(identical(other.density, density) || other.density == density)&&const DeepCollectionEquality().equals(other._measuresAdded, _measuresAdded)&&const DeepCollectionEquality().equals(other._measuresRemoved, _measuresRemoved)&&(identical(other.defaultMeasure, defaultMeasure) || other.defaultMeasure == defaultMeasure)&&const DeepCollectionEquality().equals(other._aliasesAdded, _aliasesAdded)&&const DeepCollectionEquality().equals(other._aliasesRemoved, _aliasesRemoved)&&(identical(other.pendingSource, pendingSource) || other.pendingSource == pendingSource)&&(identical(other.pendingSourceLabel, pendingSourceLabel) || other.pendingSourceLabel == pendingSourceLabel)&&(identical(other.pendingSourceScore, pendingSourceScore) || other.pendingSourceScore == pendingSourceScore)&&(identical(other.scanned, scanned) || other.scanned == scanned)&&(identical(other.scanApplied, scanApplied) || other.scanApplied == scanApplied)&&(identical(other.packAdded, packAdded) || other.packAdded == packAdded)&&(identical(other.redirectedSpoon, redirectedSpoon) || other.redirectedSpoon == redirectedSpoon)&&(identical(other.message, message) || other.message == message)&&(identical(other.busy, busy) || other.busy == busy));
}


@override
int get hashCode => Object.hashAll([runtimeType,row,creating,name,category,defaultUnit,basis,const DeepCollectionEquality().hash(_allowed),macros,seededMacros,macroSeed,nameSeed,servingSeed,perServing,serving,servingOfferTaken,density,const DeepCollectionEquality().hash(_measuresAdded),const DeepCollectionEquality().hash(_measuresRemoved),defaultMeasure,const DeepCollectionEquality().hash(_aliasesAdded),const DeepCollectionEquality().hash(_aliasesRemoved),pendingSource,pendingSourceLabel,pendingSourceScore,scanned,scanApplied,packAdded,redirectedSpoon,message,busy]);
...
as ServingDraft,servingOfferTaken: null == servingOfferTaken ? _self.servingOfferTaken : servingOfferTaken // ignore: cast_nullable_to_non_nullable
as bool,density: null == density ? _self.density : density // ignore: cast_nullable_to_non_nullable
as DensityChange,measuresAdded: null == measuresAdded ? _self._measuresAdded : measuresAdded // ignore: cast_nullable_to_non_nullable
...
as Set<String>,defaultMeasure: null == defaultMeasure ? _self.defaultMeasure : defaultMeasure // ignore: cast_nullable_to_non_nullable
as DefaultMeasureChange,aliasesAdded: null == aliasesAdded ? _self._aliasesAdded : aliasesAdded // ignore: cast_nullable_to_non_nullable
