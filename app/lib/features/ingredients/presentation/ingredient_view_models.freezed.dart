...
/// *keep the old word* puts back. Null when nothing was suggested.
 String? get nameWas;/// A typed name the person chose to KEEP. While [name] is exactly this,
...
as String?,namePinned: freezed == namePinned ? _self.namePinned : namePinned // ignore: cast_nullable_to_non_nullable
