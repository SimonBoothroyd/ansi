...
/// an alias. Pure Dart.
///
/// A phrase is refused when it carries a comma, a slash, a bracket or the word
/// *or*, or a word that hands the choice to the cook ("your favourite pasta").
/// Asked of the raw text, before `normalizeMatchText` strips those marks. A
/// guard test asks the same of every alias in the seed template.
library;
...
/// Words that point at the cook rather than the food. "extra" and "good" are
/// absent on purpose ("extra virgin olive oil" is a name).
const _aboutTheCook = {
