...
// is `unitFromLabel` in `unit_words.dart` — the file that owns reading a
// human's spelling. It lives there, not here, so the one rule serves every
// reader of a typed word; this file stays the catalogue itself.
