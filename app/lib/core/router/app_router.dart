...
/// It is a fact about the route, which is why it is stated here: a screen does
/// not measure itself ([AnsiPane]).
GoRoute _page({
  ...
  builder: (context, state) =>
      AnsiPane(fullWidth: fullWidth, child: builder(state)),
);
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          // same form, with no row behind it yet: nothing is written until
          ...
          // manager's stub band). Everything else lands on the row as it
          // reads.
          _page(
            path: '/ingredients/:id',
            name: 'ingredient',
          ...
          // carry it. Read exactly as `/recipes/:id/edit` reads it below. It changes
          // nothing about the page itself; it is what lets the page offer the
          // week door beside its own Edit, and the page re-checks it against
          // the week before it does.
          _page(
            path: '/recipes/:id',
            name: 'recipe',
