...
--
-- 319 ingredients (283 complete, 36 stub), 138 aliases, 272 measures.
...
-- Re-stamped this run: 0 ingredient sources, 0 alias sources.
...
with v(canonical_name, category, default_unit, macros_basis, density_g_per_ml, macros, status, source, source_label, source_score, source_edited, piece_basis_amount, piece_source, allowed_units, match_text) as (values
  ...
  ('Apricot'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6551::numeric, '{"carb":11.12,"fat":0.39,"fiber":2,"kcal":48,"protein":1.4}'::jsonb, 'complete'::text, 'usda_fdc:171697'::text, 'Apricots, raw'::text, null::numeric, false, 35::numeric, 'borrowed from apricot'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'apricot'::text),
  ...
  ('Balsamic Vinegar'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 1.0778::numeric, '{"carb":17.03,"fat":0,"kcal":88,"protein":0.49}'::jsonb, 'complete'::text, 'usda_fdc:172241'::text, 'Vinegar, balsamic'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'balsamic vinegar'::text),
  ('Banana'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.634::numeric, '{"carb":22.84,"fat":0.33,"fiber":2.6,"kcal":89,"protein":1.09}'::jsonb, 'complete'::text, 'usda_fdc:173944'::text, 'Bananas, raw'::text, null::numeric, false, 118::numeric, 'borrowed from banana, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'banana'::text),
  ...
  ('Bay Leaves'::text, 'spices & seasoning'::text, 'piece'::text, 'g'::text, 0.1217::numeric, '{"carb":74.97,"fat":8.36,"fiber":26.3,"kcal":313,"protein":7.61}'::jsonb, 'complete'::text, 'usda_fdc:170917'::text, 'Spices, bay leaf'::text, null::numeric, false, 0.2::numeric, 'borrowed from leaf'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'bay leaf'::text),
  ('Beets'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.5748::numeric, '{"carb":9.56,"fat":0.17,"fiber":2.8,"kcal":43,"protein":1.61}'::jsonb, 'complete'::text, 'usda_fdc:169145'::text, 'Beets, raw'::text, null::numeric, false, 82::numeric, 'borrowed from beet'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'beet'::text),
  ...
  ('Black Rice'::text, 'grains'::text, 'cup'::text, 'g'::text, 0.78::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'black rice'::text),
  ...
  ('Bouillon Paste'::text, 'pantry'::text, 'tsp'::text, 'g'::text, 1.22::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'bouillon paste'::text),
  ...
  ('Breaded Vegan Chicken Nugget'::text, 'proteins'::text, 'oz'::text, 'g'::text, 0.5495::numeric, null::jsonb, 'stub'::text, 'fdc_density:167719'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'breaded vegan chicken nugget'::text),
  ...
  ('Carrot'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.541::numeric, '{"carb":9.58,"fat":0.24,"fiber":2.8,"kcal":41,"protein":0.93}'::jsonb, 'complete'::text, 'usda_fdc:170393'::text, 'Carrots, raw'::text, null::numeric, false, 61::numeric, 'borrowed from carrot, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'carrot'::text),
  ...
  ('Celery'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.5072::numeric, '{"carb":2.97,"fat":0.17,"fiber":1.6,"kcal":14,"protein":0.69}'::jsonb, 'complete'::text, 'usda_fdc:169988'::text, 'Celery, raw'::text, null::numeric, false, 40::numeric, 'borrowed from stalk, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'celery'::text),
  ...
  ('Chex Cereal'::text, 'pantry'::text, 'cup'::text, 'g'::text, 0.13::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'chex cereal'::text),
  ...
  ('Chili Crisp'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 0.95::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'chili crisp'::text),
  ...
  ('Cinnamon Stick'::text, 'spices & seasoning'::text, 'piece'::text, 'g'::text, null::numeric, '{"carb":80.59,"fat":1.24,"fiber":53.1,"kcal":247,"protein":3.99}'::jsonb, 'complete'::text, 'usda_fdc:171320'::text, 'Spices, cinnamon, ground'::text, null::numeric, false, 2.6::numeric, 'borrowed from stick'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'cinnamon stick'::text),
  ...
  ('Dried Coconut Flakes'::text, 'pantry'::text, 'cup'::text, 'g'::text, 0.3593::numeric, null::jsonb, 'stub'::text, 'fdc_density:170577'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'coconut flake dried'::text),
  ('Canned Coconut Milk'::text, 'pantry'::text, 'piece'::text, 'g'::text, 0.9552::numeric, '{"carb":2.81,"fat":21.33,"kcal":197,"protein":2.02}'::jsonb, 'complete'::text, 'usda_fdc:170173'::text, 'Nuts, coconut milk, canned (liquid expressed from grated meat and water)'::text, null::numeric, false, 400::numeric, 'borrowed from can (400 ml)'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'coconut milk canned'::text),
  ...
  ('Coconut Whip'::text, 'dairy'::text, 'cup'::text, 'g'::text, 0.3::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'coconut whip'::text),
  ('Coconut Yogurt'::text, 'dairy'::text, 'cup'::text, 'g'::text, 1.03::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'coconut yogurt'::text),
  ...
  ('Corn Tortilla'::text, 'grains'::text, 'piece'::text, 'g'::text, null::numeric, '{"carb":44.64,"fat":2.85,"fiber":6.3,"kcal":218,"protein":5.7}'::jsonb, 'complete'::text, 'usda_fdc:175036'::text, 'Tortillas, ready-to-bake or -fry, corn'::text, null::numeric, false, 24::numeric, 'borrowed from tortilla'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'corn tortilla'::text),
  ...
  ('Crispy Onion'::text, 'pantry'::text, 'oz'::text, 'g'::text, 0.237::numeric, null::jsonb, 'stub'::text, 'label:French''s Crispy Fried Onions (2 tbsp = 7 g)'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'crispy onion'::text),
  ('Crispy Shallot'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 0.34::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'crispy shallot'::text),
  ('Cucumber'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.4396::numeric, '{"carb":3.63,"fat":0.11,"fiber":0.5,"kcal":15,"protein":0.65}'::jsonb, 'complete'::text, 'usda_fdc:168409'::text, 'Cucumber, with peel, raw'::text, null::numeric, false, 301::numeric, 'borrowed from cucumber'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'cucumber'::text),
  ...
  ('Dates'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6213::numeric, '{"carb":74.97,"fat":0.15,"fiber":6.7,"kcal":277,"protein":1.81}'::jsonb, 'complete'::text, 'usda_fdc:168191 + fdc_density:171726'::text, 'Dates, medjool'::text, null::numeric, false, 24::numeric, 'borrowed from date, pitted'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'date'::text),
  ('Dijon Mustard'::text, 'pantry'::text, 'tsp'::text, 'g'::text, 1.05::numeric, '{"carb":3.5,"fat":12,"kcal":161,"protein":7.5}'::jsonb, 'complete'::text, 'label:Maille Dijon Originale'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'dijon mustard'::text),
  ...
  ('Eggplant'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.3466::numeric, '{"carb":5.88,"fat":0.18,"fiber":3,"kcal":25,"protein":0.98}'::jsonb, 'complete'::text, 'usda_fdc:169228'::text, 'Eggplant, raw'::text, null::numeric, false, 548::numeric, 'borrowed from eggplant, unpeeled'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'eggplant'::text),
  ('English Muffin'::text, 'grains'::text, 'piece'::text, 'g'::text, null::numeric, '{"carb":44.8,"fat":2,"fiber":4.6,"kcal":223,"protein":8.7}'::jsonb, 'complete'::text, 'usda_fdc:172761'::text, 'Muffins, English, wheat'::text, null::numeric, false, 57::numeric, 'borrowed from muffin'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'english muffin'::text),
  ...
  ('Fennel'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.3677::numeric, '{"carb":7.3,"fat":0.2,"fiber":3.1,"kcal":31,"protein":1.24}'::jsonb, 'complete'::text, 'usda_fdc:169385'::text, 'Fennel, bulb, raw'::text, null::numeric, false, 234::numeric, 'borrowed from bulb'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'fennel'::text),
  ...
  ('Canned Fire-Roasted Tomatoes'::text, 'pantry'::text, 'oz'::text, 'g'::text, 1.0356::numeric, '{"carb":3.32,"fat":0.5,"kcal":18,"protein":0.84}'::jsonb, 'complete'::text, 'usda_fdc:333281'::text, 'Tomatoes, canned, red, ripe, diced'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'fire tomato canned roasted'::text),
  ...
  ('Gold Potato'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.59::numeric, '{"carb":15.9624,"fat":0.2638,"kcal":72,"protein":1.8125}'::jsonb, 'complete'::text, 'usda_fdc:2346403 + fao_infoods_v2:Potato, english, raw'::text, 'Potatoes, gold, without skin, raw'::text, null::numeric, false, 213::numeric, 'borrowed from potato, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'gold potato'::text),
  ...
  ('Ketchup'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 1.14::numeric, '{"carb":26.8,"fat":0.55,"kcal":117,"protein":1.11}'::jsonb, 'complete'::text, 'usda_fdc:747693'::text, 'Ketchup, restaurant'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'ketchup'::text),
  ...
  ('Kiwi'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.7608::numeric, '{"carb":14.66,"fat":0.52,"fiber":3,"kcal":61,"protein":1.14}'::jsonb, 'complete'::text, 'usda_fdc:168153'::text, 'Kiwifruit, green, raw'::text, null::numeric, false, 69::numeric, 'borrowed from kiwi, whole'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'kiwi'::text),
  ('Kombu'::text, 'pantry'::text, 'piece'::text, 'g'::text, null::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, 10::numeric, 'borrowed from strip'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'kombu'::text),
  ...
  ('Lime'::text, 'produce'::text, 'piece'::text, 'g'::text, null::numeric, '{"carb":10.54,"fat":0.2,"fiber":2.8,"kcal":30,"protein":0.7}'::jsonb, 'complete'::text, 'usda_fdc:168155'::text, 'Limes, raw'::text, null::numeric, false, 67::numeric, 'borrowed from lime, whole'::text, '["piece","g","kg","oz","lb","handful"]'::jsonb, 'lime'::text),
  ...
  ('Lion''s Mane Mushroom'::text, 'produce'::text, 'oz'::text, 'g'::text, 0.3::numeric, null::jsonb, 'stub'::text, 'typical:fdc raw-mushroom family bracket'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'lion mane mushroom'::text),
  ('Liquid Aminos'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 1.08::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","to_taste"]'::jsonb, 'liquid amino'::text),
  ('Liquid Smoke'::text, 'pantry'::text, 'dash'::text, 'g'::text, 1::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","dash"]'::jsonb, 'liquid smoke'::text),
  ...
  ('Mango'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6974::numeric, '{"carb":14.98,"fat":0.38,"fiber":1.6,"kcal":60,"protein":0.82}'::jsonb, 'complete'::text, 'usda_fdc:169910'::text, 'Mangos, raw'::text, null::numeric, false, 336::numeric, 'borrowed from mango, whole'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'mango'::text),
  ...
  ('Mint'::text, 'produce'::text, 'g'::text, 'g'::text, 0.1082::numeric, null::jsonb, 'stub'::text, 'fdc_density:173474'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'mint'::text),
  ...
  ('Nectarine'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6044::numeric, '{"carb":9.18,"fat":0.28,"fiber":1.5,"kcal":39,"protein":1.06}'::jsonb, 'complete'::text, 'usda_fdc:327357'::text, 'Nectarines, raw'::text, null::numeric, false, 129::numeric, 'borrowed from nectarine, whole'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'nectarine'::text),
  ('Nori'::text, 'pantry'::text, 'piece'::text, 'g'::text, null::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, 2.5::numeric, 'borrowed from sheet'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'nori'::text),
  ...
  ('Oat Milk'::text, 'dairy'::text, 'cup'::text, 'g'::text, 1.01::numeric, '{"carb":5.100325,"fat":2.749,"fiber":0,"kcal":48,"protein":0.796875}'::jsonb, 'complete'::text, 'usda_fdc:2257046'::text, 'Oat milk, unsweetened, plain, refrigerated'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'oat milk'::text),
  ...
  ('Onion'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6763::numeric, '{"carb":9.34,"fat":0.1,"fiber":1.7,"kcal":40,"protein":1.1}'::jsonb, 'complete'::text, 'usda_fdc:170000'::text, 'Onions, raw'::text, null::numeric, false, 110::numeric, 'borrowed from onion, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'onion'::text),
  ...
  ('Fresh Oregano'::text, 'produce'::text, 'tsp'::text, 'g'::text, 0.15::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'oregano fresh'::text),
  ...
  ('Plant Butter'::text, 'fats & oils'::text, 'tbsp'::text, 'g'::text, 0.95::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'plant butter'::text),
  ('Plant Milk'::text, 'dairy'::text, 'cup'::text, 'g'::text, 1.01::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'plant milk'::text),
  ('Plantain'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6256::numeric, '{"carb":36.66,"fat":0.07,"fiber":2.2,"kcal":152,"protein":1.25}'::jsonb, 'complete'::text, 'usda_fdc:168215 + fdc_density:169130'::text, 'Plantains, green, raw'::text, null::numeric, false, 267::numeric, 'borrowed from plantain'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'plantain'::text),
  ('Poblano Pepper'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.5::numeric, null::jsonb, 'stub'::text, 'fao_infoods_v2:Chili, green'::text, null::text, null::numeric, false, 100::numeric, 'borrowed from pepper'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'poblano pepper'::text),
  ('Portobello Mushroom'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.3635::numeric, '{"carb":3.87,"fat":0.35,"fiber":1.3,"kcal":22,"protein":2.11}'::jsonb, 'complete'::text, 'usda_fdc:169255'::text, 'Mushrooms, portabella, raw'::text, null::numeric, false, 84::numeric, 'borrowed from mushroom, whole'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'portobello mushroom'::text),
  ...
  ('Red Potato'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.634::numeric, '{"carb":15.9,"fat":0.14,"fiber":1.7,"kcal":70,"protein":1.89}'::jsonb, 'complete'::text, 'usda_fdc:170029'::text, 'Potatoes, red, flesh and skin, raw'::text, null::numeric, false, 213::numeric, 'borrowed from potato, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'red potato'::text),
  ('Red Rice'::text, 'grains'::text, 'cup'::text, 'g'::text, 0.78::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'red rice'::text),
  ...
  ('Rhubarb'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.5157::numeric, '{"carb":4.54,"fat":0.2,"fiber":1.8,"kcal":21,"protein":0.9}'::jsonb, 'complete'::text, 'usda_fdc:167758'::text, 'Rhubarb, raw'::text, null::numeric, false, 51::numeric, 'borrowed from stalk'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'rhubarb'::text),
  ('Rice Vinegar'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 1::numeric, '{"carb":1.5,"fat":0,"kcal":18,"protein":0}'::jsonb, 'complete'::text, 'label:typical unseasoned rice vinegar'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'rice vinegar'::text),
  ...
  ('Scallion'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.4227::numeric, '{"carb":7.34,"fat":0.19,"fiber":2.6,"kcal":32,"protein":1.83}'::jsonb, 'complete'::text, 'usda_fdc:170005'::text, 'Onions, spring or scallions (includes tops and bulb), raw'::text, null::numeric, false, 15::numeric, 'borrowed from scallion, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'scallion'::text),
  ('Sea Salt'::text, 'spices & seasoning'::text, 'tsp'::text, 'g'::text, 1.2342::numeric, '{"carb":0,"fat":0,"fiber":0,"kcal":0,"protein":0}'::jsonb, 'complete'::text, 'usda_fdc:173468'::text, 'Salt, table'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","pinch","dash","handful","to_taste"]'::jsonb, 'sea salt'::text),
  ('Seitan'::text, 'proteins'::text, 'oz'::text, 'g'::text, null::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb"]'::jsonb, 'seitan'::text),
  ...
  ('Shallot'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6763::numeric, '{"carb":16.8,"fat":0.1,"fiber":3.2,"kcal":72,"protein":2.5}'::jsonb, 'complete'::text, 'usda_fdc:170499'::text, 'Shallots, raw'::text, null::numeric, false, 30::numeric, 'borrowed from shallot, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'shallot'::text),
  ('Sherry Vinegar'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 1.01::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'sherry vinegar'::text),
  ('Shiitake Bacon'::text, 'proteins'::text, 'piece'::text, 'g'::text, null::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, 5::numeric, 'borrowed from slice'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'shiitake bacon'::text),
  ...
  ('Silken Tofu'::text, 'proteins'::text, 'piece'::text, 'g'::text, 1.0482::numeric, '{"carb":2.9,"fat":2.7,"fiber":0.1,"kcal":55,"protein":4.8}'::jsonb, 'complete'::text, 'usda_fdc:174292 + fdc_density:172449'::text, 'MORI-NU, Tofu, silken, soft'::text, null::numeric, false, 349::numeric, 'borrowed from block (12.3 oz)'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'silken tofu'::text),
  ('Soft Sandwich Bread'::text, 'grains'::text, 'piece'::text, 'g'::text, 0.29::numeric, '{"carb":49.2,"fat":3.59,"fiber":2.3,"kcal":270,"protein":9.43}'::jsonb, 'complete'::text, 'usda_fdc:325871 + fao_infoods_v2:Bread, white, sliced, prepacked'::text, 'Bread, white, commercially prepared'::text, null::numeric, false, 27.3::numeric, 'borrowed from slice'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'soft sandwich bread'::text),
  ('Sourdough Starter'::text, 'baking'::text, 'g'::text, 'g'::text, 0.96::numeric, null::jsonb, 'stub'::text, 'label:King Arthur ingredient weight chart (1 cup = 227 g)'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'sourdough starter'::text),
  ...
  ('Star Anise'::text, 'spices & seasoning'::text, 'piece'::text, 'g'::text, null::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, 2::numeric, 'borrowed from pod'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'star anise'::text),
  ...
  ('Tatsoi'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.06::numeric, null::jsonb, 'stub'::text, 'fao_infoods_v2:Salad, green, leaves, raw'::text, null::text, null::numeric, false, 150::numeric, 'borrowed from head'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'tatsoi'::text),
  ('Tempeh'::text, 'proteins'::text, 'oz'::text, 'g'::text, 0.7016::numeric, '{"carb":7.64,"fat":10.8,"kcal":192,"protein":20.29}'::jsonb, 'complete'::text, 'usda_fdc:174272'::text, 'Tempeh'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'tempeh'::text),
  ('Tender Greens'::text, 'produce'::text, 'cup'::text, 'g'::text, 0.1::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'tender green'::text),
  ...
  ('Tofu Bacon'::text, 'proteins'::text, 'piece'::text, 'g'::text, null::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, 15::numeric, 'borrowed from slice'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'tofu bacon'::text),
  ('Tomato'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.6298::numeric, '{"carb":3.89,"fat":0.2,"fiber":1.2,"kcal":18,"protein":0.88}'::jsonb, 'complete'::text, 'usda_fdc:170457'::text, 'Tomatoes, red, ripe, raw, year round average'::text, null::numeric, false, 123::numeric, 'borrowed from tomato, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'tomato'::text),
  ...
  ('Canned Diced Tomatoes'::text, 'pantry'::text, 'oz'::text, 'g'::text, 1.0356::numeric, '{"carb":3.32,"fat":0.5,"kcal":18,"protein":0.84}'::jsonb, 'complete'::text, 'usda_fdc:333281'::text, 'Tomatoes, canned, red, ripe, diced'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'tomato canned diced'::text),
  ...
  ('Tostada Shell'::text, 'grains'::text, 'piece'::text, 'g'::text, null::numeric, '{"carb":64.43,"fat":23.38,"fiber":5.8,"kcal":474,"protein":6.15}'::jsonb, 'complete'::text, 'usda_fdc:167525'::text, 'Tostada shells, corn'::text, null::numeric, false, 12.3::numeric, 'borrowed from shell'::text, '["piece","g","kg","oz","lb"]'::jsonb, 'tostada shell'::text),
  ...
  ('Turnip'::text, 'produce'::text, 'piece'::text, 'g'::text, 0.5495::numeric, '{"carb":6.43,"fat":0.1,"fiber":1.8,"kcal":28,"protein":0.9}'::jsonb, 'complete'::text, 'usda_fdc:170465'::text, 'Turnips, raw'::text, null::numeric, false, 122::numeric, 'borrowed from turnip, medium'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb, 'turnip'::text),
  ('Ume Plum Vinegar'::text, 'pantry'::text, 'tsp'::text, 'g'::text, 1.02::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'ume plum vinegar'::text),
  ...
  ('Vanilla Paste'::text, 'baking'::text, 'tsp'::text, 'g'::text, 1.2::numeric, '{"carb":12.65,"fat":0.06,"fiber":0,"kcal":288,"protein":0.06}'::jsonb, 'complete'::text, 'usda_fdc:173471'::text, 'Vanilla extract'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vanilla paste'::text),
  ('Vegan American Cheese'::text, 'dairy'::text, 'oz'::text, 'g'::text, 0.4776::numeric, null::jsonb, 'stub'::text, 'fdc_density:168089'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vegan american cheese'::text),
  ('Vegan Cheddar'::text, 'dairy'::text, 'oz'::text, 'g'::text, 0.4776::numeric, null::jsonb, 'stub'::text, 'fdc_density:168089'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vegan cheddar'::text),
  ('Vegan Cheese'::text, 'dairy'::text, 'oz'::text, 'g'::text, 0.4776::numeric, null::jsonb, 'stub'::text, 'fdc_density:168089'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vegan cheese'::text),
  ('Vegan Mayonnaise'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 0.96::numeric, '{"carb":7.1,"fat":71.4,"kcal":643,"protein":0}'::jsonb, 'complete'::text, 'label:Hellmann''s vegan mayo'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vegan mayonnaise'::text),
  ('Vegan Parmesan'::text, 'dairy'::text, 'cup'::text, 'g'::text, 0.42::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vegan parmesan'::text),
  ('Vegan Sausage'::text, 'proteins'::text, 'piece'::text, 'g'::text, 0.5917::numeric, null::jsonb, 'stub'::text, 'fdc_density:169887'::text, null::text, null::numeric, false, 100::numeric, 'borrowed from link'::text, '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'vegan sausage'::text),
  ('Vegan Worcestershire Sauce'::text, 'pantry'::text, 'tbsp'::text, 'g'::text, 1.16::numeric, null::jsonb, 'stub'::text, 'seed'::text, null::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","to_taste"]'::jsonb, 'vegan worcestershire sauce'::text),
  ...
  ('Cooked White Rice'::text, 'grains'::text, 'cup'::text, 'g'::text, 0.7862::numeric, '{"carb":28.59,"fat":0.21,"kcal":130,"protein":2.38}'::jsonb, 'complete'::text, 'usda_fdc:168930'::text, 'Rice, white, medium-grain, cooked, unenriched'::text, null::numeric, false, null::numeric, null::text, '["g","kg","oz","lb","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb, 'white rice cooked'::text),
...
from (values
  ...
  ('apple', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('apricot', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('arugula', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('asparagus', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('avocado', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('banana', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('basil', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('bay leaf', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('beet', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('black rice', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('blueberry', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('bouillon paste', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('brazil nut', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('bread flour', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('breaded vegan chicken nugget', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('burger bun', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('butternut squash', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('carrot', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('celery', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('chex cereal', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('chili crisp', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('cinnamon stick', '["piece","g","kg","oz","lb"]'::jsonb),
  ...
  ('coconut flake dried', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('coconut milk canned', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('coconut oil', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('coconut whip', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('coconut yogurt', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('crispy onion', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('crispy shallot', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('cucumber', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('date', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('dijon mustard', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('dill', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('dill pickle', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('eggplant', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('english muffin', '["piece","g","kg","oz","lb"]'::jsonb),
  ...
  ('fennel', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('flour tortilla', '["piece","g","kg","oz","lb"]'::jsonb),
  ('french green lentil dried', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('gala apple', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('gold potato', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('golden raisin', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('granny smith apple', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('granulated sugar', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('grapefruit', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('green bell pepper', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('jalapeno', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('kiwi', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('kombu', '["piece","g","kg","oz","lb"]'::jsonb),
  ('kosher salt', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","pinch","dash","handful","to_taste"]'::jsonb),
  ('leek', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('lemon', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('lime', '["piece","g","kg","oz","lb","handful"]'::jsonb),
  ('lime juice', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('lion mane mushroom', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('liquid amino', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","to_taste"]'::jsonb),
  ('liquid smoke', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","dash"]'::jsonb),
  ('maitake mushroom', '["g","kg","oz","lb","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('mango', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('maple syrup', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('mini pretzel', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('mint', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('multigrain bread', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('mung bean dried', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('napa cabbage', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('navy bean canned', '["g","kg","oz","lb","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('nectarine', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('onion', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('onion powder', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","pinch","dash","handful","to_taste"]'::jsonb),
  ('orange', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('orange bell pepper', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('oregano fresh', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('parsnip', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('peach', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('plant butter', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('plant milk', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('plantain', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('poblano pepper', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('portobello mushroom', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('radish', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('raisin', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('raspberry', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('red bell pepper', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('red cabbage', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('red chili fresh', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('red delicious apple', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('red onion', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('red pepper flake', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","pinch","dash","handful","to_taste"]'::jsonb),
  ('red potato', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('red rice', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('red wine vinegar', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('rhubarb', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('russet potato', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('scallion', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('sea salt', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","pinch","dash","handful","to_taste"]'::jsonb),
  ('seitan', '["g","kg","oz","lb"]'::jsonb),
  ('semolina flour', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('serrano pepper', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('shallot', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('sherry vinegar', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('shiitake bacon', '["piece","g","kg","oz","lb"]'::jsonb),
  ('shiitake mushroom', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('silken tofu', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('soft sandwich bread', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('sourdough starter', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('sprouted multigrain bread', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('sriracha', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","to_taste"]'::jsonb),
  ('star anise', '["piece","g","kg","oz","lb"]'::jsonb),
  ...
  ('sweet potato', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('tatsoi', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('tempeh', '["g","kg","oz","lb","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('tender green', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('tofu bacon', '["piece","g","kg","oz","lb"]'::jsonb),
  ('tomato', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ...
  ('tostada shell', '["piece","g","kg","oz","lb"]'::jsonb),
  ('turmeric ground', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","pinch","dash","handful","to_taste"]'::jsonb),
  ('turnip', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('ume plum vinegar', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('vegan american cheese', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('vegan cheddar', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('vegan cheese', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('vegan mayonnaise', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('vegan parmesan', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('vegan sausage', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('vegan worcestershire sauce', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","to_taste"]'::jsonb),
  ...
  ('wheat bread whole', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('white bread', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ...
  ('yellow bell pepper', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('yellow mustard', '["g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt"]'::jsonb),
  ('yellow squash', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb),
  ('zucchini', '["piece","g","kg","oz","lb","tsp","tbsp","fl_oz","cup","ml","l","pt","qt","handful"]'::jsonb)
...
join (values
  ...
  ('chex cereal', 'chex style cereal', 'chex style cereal', 'seed'),
  ...
  ('coconut yogurt', 'plain coconut yogurt', 'plain coconut yogurt', 'seed'),
  ...
  ('plant butter', 'salted cultured plant butter', 'cultured plant butter salted', 'seed'),
  ('plant butter', 'vegan butter', 'vegan butter', 'seed'),
  ...
  ('sourdough starter', 'active starter', 'active starter', 'seed'),
  ...
  ('tatsoi', 'fresh tatsoi', 'tatsoi fresh', 'seed'),
  ...
  ('vegan american cheese', 'American cheese', 'american cheese', 'seed'),
  ...
  ('vegan sausage', 'Beyond Meat Sausage', 'beyond meat sausage', 'seed'),
...
join (values
  ...
  ('kombu', 'strip', 10::numeric, 0::int, 'seed:typical'::text),
  ...
  ('poblano pepper', 'pepper', 100::numeric, 0::int, 'seed:typical'::text),
  ...
  ('shiitake bacon', 'slice', 5::numeric, 0::int, 'seed:typical'::text),
  ...
  ('tatsoi', 'head', 150::numeric, 0::int, 'seed:typical'::text),
  ...
  ('tofu bacon', 'slice', 15::numeric, 0::int, 'seed:typical'::text),
  ...
  ('vegan sausage', 'link', 100::numeric, 0::int, 'seed:typical'::text),
...
--
-- 60 of 319 rows differ from the derived rule:
...
--   liquid amino (Liquid Aminos, default tbsp): +to_taste
...
--   plant butter (Plant Butter, default tbsp): -pinch -dash -to_taste
...
--   vegan worcestershire sauce (Vegan Worcestershire Sauce, default tbsp): +to_taste
