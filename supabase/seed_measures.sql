...
join (values
  ...
  ('bay leaf', 'leaf', 0.2, 0, 'seed:typical'),
  ('beet', 'beet', 82, 0, 'usda_fdc:169145 (1 beet (2" dia))'),
  ('black bean canned', 'can (15 oz), drained', 277, 0, 'usda_fdc:174286 (1 can drained solids) — borrowed, relabeled'),
  ('black eyed pea canned', 'can (15 oz), drained', 277, 0, 'usda_fdc:174286 (1 can drained solids) — borrowed, relabeled'),
  ('blueberry', 'berry', 1.36, 0, 'usda_fdc:171711 (50 berries)'),
  ('brazil nut', 'kernel', 5, 0, 'usda_fdc:170569 (1 kernel)'),
  ('broccoli', 'whole', 608, 0, 'usda_fdc:170379 (1 bunch)'),
  ('broccoli', 'spear', 31, 1, 'usda_fdc:170379 (1 spear (about 5" long))'),
  ('broccoli', 'crown', 150, 2, 'seed:typical'),
  ('brussel sprout', 'sprout', 19, 0, 'usda_fdc:170383 (1 sprout)'),
  ('burger bun', 'bun', 44, 0, 'usda_fdc:172796 (1 roll 1 serving) — relabeled'),
  ('butternut squash', 'squash, whole', 1130, 0, 'seed:typical'),
  ...
  ('cannellini bean canned', 'can (15 oz), drained', 277, 0, 'usda_fdc:174286 (1 can drained solids) — borrowed, relabeled'),
  ...
  ('dark red kidney bean canned', 'can (15 oz), drained', 266, 0, 'usda_fdc:174285 (1 can drained solids) — relabeled'),
  ...
  ('fire tomato canned roasted', 'can (14.5 oz)', 411, 0, 'seed:typical'),
  ('fire tomato canned roasted', 'can (28 oz)', 794, 1, 'seed:typical'),
  ('flour tortilla', 'package', 484, 0, 'usda_fdc:167535 (1 package)'),
  ('flour tortilla', 'tortilla', 49, 1, 'usda_fdc:167535 (1 tortilla)'),
  ('gala apple', 'apple, medium', 172, 0, 'usda_fdc:168204 (1 medium) — borrowed'),
  ('gala apple', 'apple, large', 200, 1, 'usda_fdc:168204 (1 large) — borrowed'),
  ('gala apple', 'apple, small', 157, 2, 'usda_fdc:168204 (1 small) — borrowed'),
  ('garlic', 'clove', 3, 0, 'usda_fdc:169230 (1 clove)'),
  ('ginger', 'slice', 2.2, 0, 'usda_fdc:169231 (5 slices (1" dia))'),
  ('ginger', 'piece, 1 inch', 12, 1, 'seed:typical'),
  ...
  ('granny smith apple', 'apple, medium', 167, 0, 'usda_fdc:168203 (1 medium) — borrowed'),
  ('granny smith apple', 'apple, large', 206, 1, 'usda_fdc:168203 (1 large) — borrowed'),
  ('granny smith apple', 'apple, small', 144, 2, 'usda_fdc:168203 (1 small) — borrowed'),
  ('grapefruit', 'grapefruit, whole', 246, 0, 'usda_fdc:174673 (0.5 fruit (3-3/4" dia))'),
  ('great northern bean canned', 'can (15 oz), drained', 277, 0, 'usda_fdc:174286 (1 can drained solids) — borrowed, relabeled'),
  ('green bean', 'bean', 5.5, 0, 'usda_fdc:169961 (10 beans (4" long))'),
  ('green bean canned', 'can (14.5 oz), drained', 240, 0, 'seed:typical'),
  ...
  ('mint', 'sprig', 2, 0, 'seed:typical'),
  ('mint', 'bunch', 25, 1, 'seed:typical'),
  ...
  ('napa cabbage', 'head', 950, 0, 'seed:typical'),
  ('navy bean canned', 'can (15 oz), drained', 277, 0, 'usda_fdc:174286 (1 can drained solids) — borrowed, relabeled'),
  ('nectarine', 'nectarine, whole', 129, 0, 'usda_fdc:327357 (1.0 each 2-1/3" dia)'),
  ('nori', 'sheet', 2.5, 0, 'seed:typical'),
  ...
  ('orange juice', 'orange, juiced', 86, 0, 'usda_fdc:169098 (1 fruit yields) — relabeled'),
  ('oyster mushroom', 'mushroom', 15, 0, 'usda_fdc:168580 (1 small) — relabeled'),
  ('parsley', 'sprig', 1, 0, 'usda_fdc:170416 (10 sprigs)'),
  ('parsnip', 'parsnip, medium', 120, 0, 'seed:typical'),
  ...
  ('pinto bean canned', 'can (15 oz), drained', 277, 0, 'usda_fdc:174286 (1 can drained solids) — relabeled'),
  ('pistachio', 'kernel', 0.7, 0, 'usda_fdc:170184 (1 kernel)'),
  ('plantain', 'plantain', 267, 0, 'usda_fdc:168215 (1 plantain)'),
  ('poblano pepper', 'pepper', 100, 0, 'seed:typical'),
  ...
  ('red onion', 'onion, medium', 110, 1, 'usda_fdc:170000 (1 medium (2-1/2" dia)) — borrowed'),
  ('red onion', 'onion, large', 150, 2, 'usda_fdc:170000 (1 large) — borrowed'),
  ('red onion', 'onion, small', 70, 3, 'usda_fdc:170000 (1 small) — borrowed'),
  ...
  ('shiitake bacon', 'slice', 5, 0, 'seed:typical'),
  ...
  ('star anise', 'pod', 2, 0, 'seed:typical'),
  ...
  ('tomato canned', 'can (14.5 oz)', 411, 0, 'seed:typical'),
  ('tomato canned', 'can (28 oz)', 794, 1, 'seed:typical'),
  ('tomato canned whole', 'can (14.5 oz)', 411, 0, 'seed:typical'),
  ('tomato canned whole', 'tomato, medium', 111, 1, 'usda_fdc:170051 (1 medium)'),
  ('tomato canned whole', 'can (28 oz)', 794, 1, 'seed:typical'),
  ...
  ('tomato paste', 'can (6 oz)', 170, 0, 'usda_fdc:170459 (1 can (6 oz)) — relabeled'),
  ('tomato puree canned', 'can (29 oz)', 822, 0, 'usda_fdc:170460 (1 can (29 oz) (401 x 411)) — relabeled'),
  ('tomato puree canned', 'can (15 oz)', 425, 1, 'seed:typical'),
  ('tomato sauce canned', 'can (15 oz)', 425, 0, 'seed:typical'),
  ('tomato sauce canned', 'can (8 oz)', 227, 1, 'seed:typical'),
  ...
  ('vegan sausage', 'link', 100, 0, 'seed:typical'),
  ('vegetable broth', 'can (14.5 oz)', 390, 0, 'usda_fdc:171583 (1 can) — relabeled'),
  ('vegetable broth', 'carton (32 oz)', 926, 1, 'usda_fdc:171583 (1 carton (32 oz)) — relabeled'),
