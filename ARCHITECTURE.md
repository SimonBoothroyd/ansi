...
| Ingredient data model + vocab | 🟢 | 319 seeded rows with curated measures, explicit per-ingredient `allowed_units` and 307 densities; one admission rule with a Dart mirror and shared vectors keeps SQL and app honest. | [ADR-0009](./docs/decisions/0009-density-unlocks-both-families.md) · [db-schema.md](./docs/generated/db-schema.md) |
