...
| Books (`features/books`) | 🟢 | Library v3 — a search field and one link for a header, creation on the rows, the book `⋯` with the refused delete — host-tested and driven on a simulator by all seven smoke files. | [plan 0028](./docs/exec-plans/completed/0028-library-v3.md) |
